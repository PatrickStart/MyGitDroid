 ...
 */
public class RepoListFooterView extends FrameLayout {
    ...
    public RepoListFooterView(Context context) {
        this(context, null);
    }

    public RepoListFooterView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RepoListFooterView(Context context, AttributeSet attrs, int defStyleAttr) {
